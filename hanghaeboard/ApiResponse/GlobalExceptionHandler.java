...
import static com.sparta.hanghaeboard.ApiResponse.ErrorCode.BAD_ID_PASSWORD;
import static com.sparta.hanghaeboard.ApiResponse.ErrorCode.DUPLICATE_RESOURCE;
...
public class GlobalExceptionHandler {
    ...
    protected ApiResult handleCustomException(CustomException e) {                                                      // Exception 발생 시 넘겨받은 ErrorCode 를 사용해서 사용자에게 보여주는 에러 메세지를 정의
        ...
        return ApiUtil.errorResponse(e.getErrorCode());
    }
